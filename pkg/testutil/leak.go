...
running(leaking) after all tests.
	...
	import "github.com/divebomb/exocet/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/divebomb/exocet/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/divebomb/exocet/pkg/logutil.(*MergeLogger).outputLoop") ||
